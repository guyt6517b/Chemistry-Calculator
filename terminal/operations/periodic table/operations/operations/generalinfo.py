def _():
    ...
    if element.isnumeric():
        elementsy = cc.atomicNumToSymbol[element]
    else:
    ...
    try:
        ...
        try:
            elementsy = cc.nameToSymbol[element].lower()
    ...
    protons = atomicNum
    neutrons = round(weight - protons) if protons <= weight else float('nan')
    electrons = protons
    ...
    if choice == "y":
        bohr_animation_auto(element, atomicNum)